...
export default function Generator(props) {
    ...
    const { poison, setPoison, muscles, setMuscles, goal, setGoal, 
        updateWorkout
     } = props
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s',
            'Huge', 'o\'clock']}>
            ...
            <Header index={'03'} title={'Become Juggernaut'}
                description={'Select your Ulitmate Objective.'} />
...
// SectioWrapper is a child component of the Generator so the text asdasdasd in the 
// SectionWrapper tags is being displayed via the props which are defined in the 
// SectionWrapper component

// Generator is the parent component of SectionWrapper and Header 